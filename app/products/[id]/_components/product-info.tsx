  ...
  return (
    <>
      <div className="relative z-50 mt-[-1.5rem] rounded-tl-3xl rounded-tr-3xl bg-white p-5">
        ...
        <div className="mt-6 gap-2 space-y-3  md:justify-center md:p-5">
          <h3 className="mb-5 font-semibold md:flex md:justify-center">
            Sobre
          </h3>
          <p className=" text-sm text-muted-foreground">
            {product.description}
        ...
        <div className="mt-6 flex gap-2 space-y-3 md:flex  md:justify-center md:p-5">
          <h3 className="mb-5 font-semibold md:flex md:justify-center">
            Sucos
          </h3>
        </div>

        <div className=" flex gap-2 space-y-3 md:flex  md:justify-center md:p-5">
